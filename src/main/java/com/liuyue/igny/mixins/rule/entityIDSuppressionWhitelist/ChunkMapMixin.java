...
public class ChunkMapMixin {
    ...
    private boolean containsKey(Int2ObjectMap<?> instance, int i, Operation<Boolean> original, @Local(argsOnly = true) Entity entity) {
        ...
        if (IGNYSettings.entityIDSuppressionWhitelist.equals("#all") || IGNYSettings.EIDWhitelist.contains(entityTypeName)) {
            return original.call(instance, i);
        }
        if (IGNYSettings.entityIDSuppressionWhitelist.equals("#none")) {
            return false;
        }
        return original.call(instance, i);
    }
