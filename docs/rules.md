...
## 显示规则来源 (showRuleSource) `🐛Beta`

在规则详情中显示注册当前规则的Mod的ID。
...
## 末地可创建下界传送门 (theEndCanCreateNetherPortal) `🐛Beta`
...
## 可再生末地折跃门 (renewableEndGatewayPortal) `🐛Beta`
...
## 末地折跃门无冷却 (endGatewayPortalNoCooldown) `🐛Beta`
...
## 流体源可挖掘 (liquidSourceCanDestroy) `🐛Beta`
...
## 更好地加速游戏刻 (betterSprintGameTick) `🐛Beta`
...
## 重新引入绊线钩复制 (tripwireHookDupeReintroduced) `🐛Beta` `MC>=26.1`
