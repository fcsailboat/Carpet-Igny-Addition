...
## 假玩家内存泄露修复 (fakePlayerMemoryLeakFix) `🐛Beta` `MC<26.1`
...
## 重新引入生物寻路现实时间计时器 (mobPathNavigationRealTimeTimerReintroduced) `🐛Beta`

重新引入1.19.3(22w43a)以下的生物寻路使用系统时钟计时，而非游戏刻计时。
