...
## 无主TNT抢夺三 (noOwnerTntLootingIII) `🐛Beta`

当TNT爆炸时，如果伤害来源实体为空，那么因为爆炸死亡的实体则应用抢夺附魔等级3的效果。
...
## 全局阳光探测器 (globalDaylightDetector) `🐛Beta`
...
## 宽松的末影珍珠加载 (looseEnderPearlChunkLoading) `🐛Beta`

让末影珍珠不再等到加载票完全耗尽后再添加加载票，而是距离超时时间还有5个游戏刻的时候添加加载票。
